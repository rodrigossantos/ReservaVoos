...
include "NuSoap/nusoap.php";
	...
	//$result = json_decode($resultEnc,true);//CHACAR TRUE
	
	//VERSAO TESTE
	$resultEnc = $consumer->AutenticaUsu($infoBusca);
	$result = json_decode($resultEnc,true);
...
<?php
	...
	while($vooListIterator->hasNextVoo()){
		...
		echo "Nome: <p id='nome'>".$voo->getNome()."</p>";
		echo "Nip: <p id='nip'>".$voo->getNip()."</p>";
		echo "Email: <p id='email'>".$voo->getEmail()."</p>";
		echo "</article>";
